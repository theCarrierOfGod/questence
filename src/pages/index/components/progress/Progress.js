                                        ...
                                        <tbody>
                                            {newHook.programs.map((program) => (
                                                <tr key={program.course_id.id}>
                                                    ...
                                                    <td>
                                                        <Link to={`/edit/basic/${program.course_id.id}`} className='link text-info'>
                    ...
                    <div className="modal-content p-3">
                        ...
                        <div className={`${style.modalBody} modal-body`}>
                            <div className="form-group mb-3">
                                ...
                                <input type="text" name="courseCode" id="courseCode" required onChange={(e) => newHook.setNewCourseCode(e.target.value)} className="form-control" placeholder="" aria-describedby="helpId" />
                            </div>
                            <div className="form-group mb-3">
                                <label className="label" htmlFor="courseName">
                                    Course Name
                                </label>
                                <input type="text" name="courseName" required onChange={(e) => newHook.setNewCourseName(e.target.value)} id="courseName" className="form-control" placeholder="" aria-describedby="helpId" />
                            </div>
                        </div>
